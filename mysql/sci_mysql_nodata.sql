...
CREATE TABLE `t_sys_normal_account` (
  ...
  `LOGNUM` int(11) DEFAULT NULL COMMENT '登录次数',
  `USER_ID` int(11) DEFAULT NULL,
  PRIMARY KEY (`ACCOUNT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='登录帐号';
...
CREATE TABLE `t_sys_normal_user` (
  ...
  PRIMARY KEY (`USER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户明细信息表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='供应商资质类型字典表';
