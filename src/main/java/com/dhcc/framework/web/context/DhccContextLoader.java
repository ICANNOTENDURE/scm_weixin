 ...
 * Called by {@link DhccContextLoaderListener}.
 *
 ...
 * @author Sam Brannen
 * @since 17.02.2003
 * @see DhccContextLoaderListener
 * @see ConfigurableWebApplicationContext
 * @see org.springframework.web.context.support.XmlWebApplicationContext
 */
public class DhccContextLoader {
	...
	static {
		...
		try {
			ClassPathResource resource = new ClassPathResource(DEFAULT_STRATEGIES_PATH, DhccContextLoader.class);
			defaultStrategies = PropertiesLoaderUtils.loadProperties(resource);
		}
		catch (IOException ex) {
			defaultStrategies = new Properties();
			String key = "org.springframework.web.context.WebApplicationContext";
			String value = "org.springframework.web.context.support.XmlWebApplicationContext";
			defaultStrategies.put(key, value);
	 ...
	 * @see #closeWebApplicationContext(ServletContext)
	 */
	public DhccContextLoader(WebApplicationContext context) {
