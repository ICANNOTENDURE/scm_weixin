...
public class OrderInfoVo implements java.io.Serializable{
	...
	public String getHopuom() {
		return hopuom;
	}

	public void setHopuom(String hopuom) {
		this.hopuom = hopuom;
	}
	...
	public Float getHopqty() {
		return hopqty;
	}

	public void setHopqty(Float hopqty) {
		this.hopqty = hopqty;
	}
