  ...
  <div class="am-g">
	...
	<!-- 用户名，密码框 -->
		<div class="am-g">
	    		...
	    		<form method="post" class="am-form">
				  ...
				  <div class="am-panel-bd" >
				    	<div class="am-input-group">
				      	  	...
				      	  	<input type="text" name="mp_userName" id="mp_userName" value="nur123" placeholder="请输入用户名">
				      		</div>
				      		<span><hr></span>
				      		<div class="am-input-group">
					      	<span class="am-input-group-label"><i class="am-icon-lock"></i></span>
					      	<input type="password" name="mp_password" id="mp_password" value="1" placeholder="请输入密码">
			      		</div>
				  </div>
				</section>
	      		<!--  
		  ...
		  -->
	      <div class="am-cf">
	        <button type="button" class="am-btn am-btn-mt am-btn-block" onclick="javascript: SendAuthen();">登录</button>
	        <a  href="javascript:vendorRegist();" ><span style='color:#09aa83'>供应商注册</span></a>
	        &nbsp;&nbsp;&nbsp;&nbsp;
	        <a  href="javascript:auditResult();" ><span style='color:#09aa83'>查询审核结果</span></a>
	      </div>
	    </form> 
	  </div>
	</div>
