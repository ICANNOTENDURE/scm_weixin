...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/dhcc/pms/ord/State.js"></script>
</head>
<body>
	...
	<table id="datagrid" title='订单状态维护'
			...
			<table id="saveOrUpdateTable" style="width: 100%;">
				...
				<tr>
					...
					<td class="textParent" style="text-align: left; width: 30%"><input
						...
						name="dto.state.stateCode" data-options="required:true"></input>
					</td>
				</tr>
				<tr>
					...
					<td class="textParent" style="text-align: left; width: 30%"><input
						style="width: 250px;" class="validatebox" type="text"
						name="dto.state.stateName" data-options="required:true"></input>
					</td>
				</tr>
				<tr>
					<td class="textLabel" style="text-align: right; width: 20%">状态顺序:</td>
					<td class="textParent" style="text-align: left; width: 30%"><input
						style="width: 250px;" class="numberbox" type="text"
						name="dto.state.stateSeq"></input>
					</td>
				</tr>
			</table>	
