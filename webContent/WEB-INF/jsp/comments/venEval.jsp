...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/comment/venEval.js"></script>
		...
		<div class="am-panel dhcc-panel-mt">
			<div class="am-panel-hd">
				<h3 class="am-panel-title">
					<span class="am-icon-cubes"></span>&nbsp;&nbsp;&nbsp;供应商评价
				</h3>
			</div>
			<div class="am-panel-bd" style="min-height: 450px">
				...
				<div class="am-g" >
					<div class="am-u-lg-12" style="margin-top: 5px">
						...
						<input type="number" id="queryValue"/>
					</div>
				</div>
				<div class="am-g">
							...
							<div class="am-tabs-bd">
								<div data-tab-panel-0 class="am-tab-panel am-active">
									...
									<table
										...
										<thead>
											<tr >
												<th style="width: 100px" rowspan="2">供应商名称</th>
