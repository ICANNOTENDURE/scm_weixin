...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/dhcc/pms/demo/student.js"></script>
</head>
<body>
	...
	<div id="detailWin" class="dialog" 
		...
		<form id="detail" method="post">
			<table id="saveOrUpdateTable" style="width: 100%;">
				<input type="hidden" name="dto.student.studentId"/><tr><td class='textLabel' style='text-align: right; width: 20%'>学生姓名:</td><td class='textParent' style='text-align: left; width: 30%'> <input style='width: 250px;' class='validatebox' type='text' name='dto.student.studentName' ></input></td></tr><tr><td class='textLabel' style='text-align: right; width: 20%'>学生生日:</td><td class='textParent' style='text-align: left; width: 30%'> <input style='width: 250px;' class='validatebox' type='text' name='dto.student.studentBirth' ></input></td></tr>
			</table>
