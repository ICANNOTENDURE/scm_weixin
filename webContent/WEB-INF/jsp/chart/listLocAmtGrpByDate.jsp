...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/dhcc/pms/chart/listLocAmtGrpByDate.js"></script>
		...
		<div class="am-panel dhcc-panel-mt">
			<div class="am-panel-hd">
				<h3 class="am-panel-title">
					<span class="am-icon-cubes"></span>&nbsp;&nbsp;&nbsp;科室采购金额环比查询
				</h3>
			</div>
			<div class="am-panel-bd" style="min-height: 450px">
				<div class="am-g">
					...
					<div class="am-u-lg-4" style="padding: 0px">
						<select
							data-am-selected="{btnWidth: '300px',btnSize: 'xs',maxHeight: 300}"
							id="queryType">
