...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/dhcc/pms/chart/locGroupAmt.js"></script>
		...
		<div class="am-panel dhcc-panel-mt">
			<div class="am-panel-hd">
				<h3 class="am-panel-title">
					<span class="am-icon-cubes"></span>&nbsp;&nbsp;&nbsp;按商品分类汇总
				</h3>
			</div>
					...
					<div class="am-u-lg-12" style="padding: 0px; margin: 0px">
						...
						<div data-am-widget="tabs" class="am-tabs am-tabs-one">
							<ul class="am-tabs-nav am-cf">
								...
								<li  class="am-active"><a href="[data-tab-panel-1]">嵌套饼图</a></li>
								<li class=""><a href="[data-tab-panel-2]">瀑布图</a></li>
							</ul>
