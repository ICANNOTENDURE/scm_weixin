...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/dhcc/pms/ven/VenIncPic.js"></script>
<script type="text/javascript"
	...
	<div id="drugPicInfoWin" class="dialog" title="新增药品图片信息"
		...
		<table style="width: 100%;" cellspacing="10">
			<tr style="display: none">
				<input type="hidden" name="dto.venIncPic.venIncPicId" />
			</tr>
			<tr>
				<td class="textLabel">药品:</td>
				<td class="textParent"><input style="width: 250px;"
					class="combogrid" type="text" name="dto.venIncPic.venIncPicVenincid"
					data-options="required:true" id="venIncPicVenincid" /></td>
			</tr>			
			<tr>
				<td class="textLabel">图片顺序:</td>
				<td class="textParent"><input style="width: 250px;"
					class="validatebox" type="text" name="dto.venIncPic.venIncPicSeq"
					data-options="required:true" id="venIncPicSeq" /></td>
			</tr>					
			<tr>
